...
String _$hasSeenTutorialHash() => r'1b783340f2d0408c7afeee917bd98153ec9130ac';

/// See also [hasSeenTutorial].
@ProviderFor(hasSeenTutorial)
final hasSeenTutorialProvider = AutoDisposeFutureProvider<bool>.internal(
  hasSeenTutorial,
  name: r'hasSeenTutorialProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$hasSeenTutorialHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef HasSeenTutorialRef = AutoDisposeFutureProviderRef<bool>;
