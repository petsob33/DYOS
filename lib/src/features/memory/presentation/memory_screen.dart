...
final _mockMemories = [
  const MemoryItem(
    caption: 'Večeře v Aromi',
    date: '15. prosince 2024',
    monthYear: 'Prosinec 2024',
    location: 'Prague',
    tags: ['date', 'food'],
  ),
  const MemoryItem(
    caption: 'Víkend v Českém Krumlově',
  ...
  const MemoryItem(
    caption: 'První společná dovolená',
    date: '1. listopadu 2024',
    monthYear: 'Listopad 2024',
    location: 'Maledivy',
    tags: ['milestone', 'trip'],
  ),
  const MemoryItem(
    caption: 'Spontánní pik nik v parku',
    date: '20. října 2024',
    monthYear: 'Říjen 2024',
    location: 'Letná',
    tags: ['date'],
  ),
  const MemoryItem(
    caption: 'Koncert na Václaváku',
    date: '5. října 2024',
    monthYear: 'Říjen 2024',
    location: 'Prague',
    tags: ['date'],
  ...
  const MemoryItem(
    caption: 'Letní festival',
    date: '28. srpna 2024',
    monthYear: 'Srpen 2024',
    location: 'Brno',
    tags: ['trip', 'výlety'],
  ),
  const MemoryItem(
    caption: 'Romantická večeře u svíček',
    date: '14. srpna 2024',
    monthYear: 'Srpen 2024',
    location: 'Prague',
    tags: ['date', 'rande'],
